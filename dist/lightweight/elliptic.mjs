/*! OpenPGP.js v5.0.0 - 2021-02-05 - this is LGPL licensed code, see LICENSE/our website https://openpgpjs.org/ for more information. */
const globalThis = typeof window !== 'undefined' ? window : typeof global !== 'undefined' ? global : typeof self !== 'undefined' ? self : {};

import { c as createCommonjsModule, b as assert$9, i as inherits, r as require$$0, s as shaCommon, d as require$$1, _ as _224, e as _384, f as require$$2, g as require$$4, h as ripemd } from './openpgp.mjs';
...
var rotl32 = require$$0.rotl32;
var sum32 = require$$0.sum32;
var sum32_5 = require$$0.sum32_5;
var ft_1 = shaCommon.ft_1;
var BlockHash = require$$1.BlockHash;
...
require$$0.inherits(SHA1, BlockHash);
var _1 = SHA1;
...
SHA1.prototype._digest = function digest(enc) {
  if (enc === 'hex')
    return require$$0.toHex32(this.h, 'big');
  else
    return require$$0.split32(this.h, 'big');
};

var sha1 = _1;
var sha224 = _224;
var sha256 = require$$2;
var sha384 = _384;
var sha512 = require$$4;
...
function Hmac(hash, key, enc) {
  ...
  this._init(require$$0.toArray(key, enc));
}
var hmac = Hmac;
...
hash.utils = require$$0;
hash.common = require$$1;
hash.sha = sha;
hash.ripemd = ripemd;
hash.hmac = hmac;
...
function HmacDRBG(options) {
  ...
  assert$9(entropy.length >= (this.minEntropy / 8),
